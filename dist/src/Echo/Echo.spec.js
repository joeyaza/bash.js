...
const HelperMethods_1 = require("../HelperMethods/HelperMethods");
jest.mock("./HelperMethods/HelperMethods");
const helperMethods = new HelperMethods_1.default(), echo = new Echo_1.default(helperMethods), helpersDoneSpy = jest.spyOn(helperMethods, "done");
describe("Echo", () => {
